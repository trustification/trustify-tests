...
const cdxProductCpeNoSpecialChars = "cpe:/o:redhat:enterprise_linux:8.10::baseos";
...
const spdxComponentPurl = "pkg:rpm/redhat/openssl@3.0.7-18.el9_2?arch=src&repository_id=rhel-9-for-aarch64-baseos-aus-source-rpms";
...
test("Product-Component / CDX / Product SBOM provides information from component SBOM / Get with CPE", async ({ axios }) => {
...
test("Product-Component / SPDX / Product SBOM provides information from component SBOM / Get with CPE", async ({ axios }) => {
...
test.skip("Product-Component / SPDX / Component SBOM provides information from product SBOM / Get with Purl", async ({ axios }) => {
