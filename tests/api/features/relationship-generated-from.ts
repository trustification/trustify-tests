...
const spdxDocumentId = "https://www.redhat.com/openssl-3.0.7-18.el9_2.spdx.json";

// Effectively tests TC-2050 / TC-2051 - Denote src to binary rpm relationship.
test("Generated from / CDX / Source has descendants that include binaries / Get with pURL", async ({ axios }) => {
...
test("Generated from / CDX / Binary has ancestors that include the source / Get with pURL", async ({ axios }) => {
...
test("Generated from / SPDX / Source has descendants that include binaries / Get with pURL", async ({ axios }) => {
...
test("Generated from / SPDX / Binary has ancestors that include the source / Get with pURL", async ({ axios }) => {
